...
class Example extends React.Component {
  constructor(props) {
    ...
    // Maybe I need to name and motto to window.cs142models.exampleModel().name 
    var modelData = window.cs142models.exampleModel();
    this.state = {
      name: modelData.name,
      counter: 0, 
      inputValue: '',
      buttonWasClicked: this.cs142,
  ...
  render() {
    return (
      <div className="container Example">
        ...
        <br></br>
          Change your motto here:
        <br></br>
        <input id="motto-input" type='text' value={this.state.motto} onChange={this.handleMottoChange} />
